...
def move_motor(idx_X, idx_Y, *, X_offset=0, Y_offset=0, X_step=X_motor_step, Y_step=Y_motor_step):
    script.move_motor([idx_X*X_step + X_offset, idx_Y*Y_step + Y_offset, safety_z])
